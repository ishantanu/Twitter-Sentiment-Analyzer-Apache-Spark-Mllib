package org.iamShantanu101.spark.SentimentAnalyzer
...
import org.iamShantanu101.spark.SentimentAnalyzer.corenlp.CoreNLPSentimentAnalyzer
import org.iamShantanu101.spark.SentimentAnalyzer.mllib.MLlibSentimentAnalyzer
import org.iamShantanu101.spark.SentimentAnalyzer.utils.{LogUtils, PropertiesLoader, StopwordsLoader}
import org.iamShantanu101.spark.SentimentAnalyzer.utils._
...
/**
  ...
  */
// spark-submit --class "org.iamShantanu101.spark.TweetSentimentAnalyzer" --master spark://spark:7077 mllib-tweet-sentiment-analysis-assembly-0.1.jar
