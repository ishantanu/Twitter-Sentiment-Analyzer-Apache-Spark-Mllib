package org.iamShantanu101.spark.SentimentAnalyzer.corenlp
...
import org.iamShantanu101.spark.SentimentAnalyzer.utils.{LogUtils, OAuthUtils, PropertiesLoader, SQLContextSingleton}
