package org.iamShantanu101.spark.SentimentAnalyzer.mllib
...
import org.iamShantanu101.spark.SentimentAnalyzer.utils.{LogUtils, PropertiesLoader, SQLContextSingleton, StopwordsLoader}
...
/**
  ...
  */
// spark-submit --class "SparkNaiveBayesModelCreator" --master spark://spark:7077 spark-streaming-corenp-mllib-tweet-sentiment-assembly-0.1.jar
